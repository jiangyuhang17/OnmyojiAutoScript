...
截至 2026-08-16，独立的新式神识别器支持 13 个目标，共 57 张带透明蒙版的模板，统一阈值为 `0.85`。
...
- SP：龙吟铃鹿御前、遥念烟烟罗、晴思日和坊、梦山白藏主、灼华桃花妖、天火命铃彦姬。
- SSR：思金神、市加美、祸津神、猫川、鬼金羊、歌留多、卑弥呼、雪御前、葛叶、毗沙门天、不相狐禅。
...
连续学习模式会缓存三次鬼王候选检测画面，并在撒豆阶段每 `0.5` 秒缓存一张完整游戏画面。JPEG 质量为 92，一局结束后写入：
